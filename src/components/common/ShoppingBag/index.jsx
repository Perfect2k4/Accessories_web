...
const ShoppingBag = ({ open, onclose }) => {
  ...
  if (!open) return null;
  return (
    <div className="fixed top-0 right-0 z-[100] w-[120vw] h-[120vw] bg-black bg-opacity-50 ">
      <div className="fixed top-0 right-0  overflow-x-hidden overflow-y-auto ">
        <div
          className={`fixed top-0 right-0 h-[1005px] w-[420px] bg-white z-[100] ${
            isClosing ? "closing" : ""
          }`}
        >
